...
```text
_posts/2026-05-14-test-post.md
```
...
```text
https://sidsru.github.io/posts/test-post/
```
...
```text
assets/img/posts/2026-05-14-test-post/screenshot.png
```

Markdown에서 사용:

```markdown
![스크린샷](/assets/img/posts/2026-05-14-test-post/screenshot.png)
```
